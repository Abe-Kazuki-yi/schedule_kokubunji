error id: file://<WORKSPACE>/src/main/scala/controller/AuthController.scala:service/AuthService#findGoogleUser().
file://<WORKSPACE>/src/main/scala/controller/AuthController.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -play/api/mvc/authService/findGoogleUser.
	 -play/api/mvc/authService/findGoogleUser#
	 -play/api/mvc/authService/findGoogleUser().
	 -play/api/libs/json/authService/findGoogleUser.
	 -play/api/libs/json/authService/findGoogleUser#
	 -play/api/libs/json/authService/findGoogleUser().
	 -play/api/libs/ws/authService/findGoogleUser.
	 -play/api/libs/ws/authService/findGoogleUser#
	 -play/api/libs/ws/authService/findGoogleUser().
	 -javax/inject/authService/findGoogleUser.
	 -javax/inject/authService/findGoogleUser#
	 -javax/inject/authService/findGoogleUser().
	 -struct/RoleEnum.authService.findGoogleUser.
	 -struct/RoleEnum.authService.findGoogleUser#
	 -struct/RoleEnum.authService.findGoogleUser().
	 -struct/AccountTypeEnum.authService.findGoogleUser.
	 -struct/AccountTypeEnum.authService.findGoogleUser#
	 -struct/AccountTypeEnum.authService.findGoogleUser().
	 -authService/findGoogleUser.
	 -authService/findGoogleUser#
	 -authService/findGoogleUser().
	 -scala/Predef.authService.findGoogleUser.
	 -scala/Predef.authService.findGoogleUser#
	 -scala/Predef.authService.findGoogleUser().
offset: 6878
        ...
        data => {
            ...
            tokenRequest.flatMap { tokenResp =>
                ...
                userInfoReq.flatMap { userResp =>
                    ...
                    // GoogleIdでのユーザがいればログイン
                    userReposito@@ry.findGoogleUser(googleId).map {
                        case Some(user) =>
                            val token = jwtUtil.createToken(user.id, user.role)
                            Ok(Json.obj(
                                "message" -> "Login success",
