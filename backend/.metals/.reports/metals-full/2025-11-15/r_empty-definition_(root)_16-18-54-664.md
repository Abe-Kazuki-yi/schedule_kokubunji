error id: file://<WORKSPACE>/src/main/scala/controller/AuthController.scala:model/User#role.
file://<WORKSPACE>/src/main/scala/controller/AuthController.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol model/User#role.
            ...
            tokenRequest.flatMap { tokenResp =>
                ...
                userInfoReq.flatMap { userResp =>
                    ...
                    userRepository.findGoogleUser(googleId).map {
                        case Some(user) =>
                            val token = jwtUtil.createToken(user.id, user.r@@ole)
                            Ok(Json.obj(
                                "message" -> "Login success",
                                "token" -> token,
                                "role" -> user.role
