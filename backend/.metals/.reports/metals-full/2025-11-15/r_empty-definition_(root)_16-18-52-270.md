error id: file://<WORKSPACE>/src/main/scala/controller/AuthController.scala:scala/concurrent/Future#map().
file://<WORKSPACE>/src/main/scala/controller/AuthController.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol scala/concurrent/Future#map().
