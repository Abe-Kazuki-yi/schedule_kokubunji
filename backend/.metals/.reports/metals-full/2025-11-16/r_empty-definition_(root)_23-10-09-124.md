error id: file://<WORKSPACE>/src/main/scala/repository/UserRepository.scala:repository/UserRepository#users.
...
class UserRepository @Inject()(
  ...
  private val Users = TableQuery[UserTable]
    ...
    def findByUsername(username: String): Future[Option[User]] = {
        db.run(u@@sers.filter(_.username === Option(username)).result.headOption)
    }
